...
<html lang="zh-CN">
 <head> 
  ...
  <!--QQ应用模式--> 
  <title>我的专属PC</title>
  <meta name="keywords" content="我的专属PC">
 ...
 <body> 
  ...
  <div class="list closed"> 
   <ul>
    ...
    <li><a rel="nofollow" href="http://idc.itmppd.com" target="_blank"><i class="iconfont icon-kologom" style="color: #f03;"></i>MPPD云</a></li>
    <li><a rel="nofollow" href="http://lingchenw.cn" target="_blank"><i class="iconfont icon-tupian" style="color: #f90;"></i>凌晨学院网</a></li>
    <li><a rel="nofollow" href="http://lingchenw.com" target="_blank"><i class="iconfont icon-Qyouhuiquan" style="color: #2196f3;"></i>凌晨网</a></li>
    <!----> 
